...
# https://github.com/sigmadream/practice-r/blob/main/rscripts/chapter09.R
install.packages("remotes") # github 설치용
remotes::install_github("bit2r/bitTA")  # 아이디/저장소명 # 한국어 형태소 분석
bitTA::install_mecab_ko() # 한국어 형태소 사전 및 형태소 분석기 다운로드
