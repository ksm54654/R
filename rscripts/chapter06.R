...
# 실습: mutate() 함수에 의해 추가된 칼럼 뵉  # 열추가를 select
select(mutate(hflights_df, gain = ArrDelay - DepDelay, 
              gain_per_hour = gain / (AirTime / 60)), # 데이터 셋
       Year, Month, ArrDelay, DepDelay, gain, gain_per_hour) # select
