...
seq(1, 10, 2) # 1부터 10까지 +2 

# rep() 함수를 이용한 벡터 생성
rep(1:3, 3) # 1부터 3까지 3번
...
library(stringr)
str_extract("홍길동35이순신45유관순25", "[1-9]{2}") # 숫자 2개
str_extract_all("홍길동35이순신45유관순25", "[1-9]{2}") # 숫자 2개 전부다 
...
str_extract_all(string, "[a-z]{3}") # 소문자
str_extract_all(string, "[0-9]{4}") # 숫자
